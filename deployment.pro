...
isSubcomponent('deploymentview::DV','Node1','others','IV_gr740_candriver','SYSTEM','interfaceview::IV::gr740_candriver.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_gr740_candriver','Taste::FunctionName','"gr740_candriver"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_gr740_candriver','Taste::APLC_Binding','(reference (gr740_partition))','').
isSubcomponent('deploymentview::DV','Node1','others','IV_candriver_test','SYSTEM','interfaceview::IV::candriver_test.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_candriver_test','Taste::FunctionName','"candriver_test"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_candriver_test','Taste::APLC_Binding','(reference (gr740_partition))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','gr740_partition','Taste::coordinates','"132081 77242 166651 106178"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','gr740_rtems51_posix','Taste::coordinates','"127760 68975 170972 110312"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"122359 57164 176373 116217"','').
