...
isProperty('NIL','=>','interfaceview::IV','gr740_candriver','others','flagsToCompileWith','Taste::FS_Default_Value','"compiler-option: ""-DCONFIGURE_DRIVER_AMBAPP_GAISLER_GRCAN"""','').
...
isFeature('PARAMETER','interfaceview::FV::gr740_candriver','PI_commands','cmds','IN','NIL','DataView::Base_commands_Joints','NIL','NIL','').
...
isProperty('NIL','=>','interfaceview::IV','gr740_candriver','NIL','RI_samples','Taste::labelInheritance','"false"','').
isFeature('PARAMETER','interfaceview::FV::gr740_candriver','RI_samples','smpls','IN','NIL','DataView::Base_commands_Joints','NIL','NIL','').
...
isFeature('PARAMETER','interfaceview::FV::candriver_test','PI_samples','smpls','IN','NIL','DataView::Base_commands_Joints','NIL','NIL','').
...
isFeature('PARAMETER','interfaceview::FV::candriver_test','RI_commands','cmds','IN','NIL','DataView::Base_commands_Joints','NIL','NIL','').
